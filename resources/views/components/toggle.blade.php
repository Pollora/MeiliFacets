...
<button type="button" class="meilifacetsFacetToggle" aria-expanded="false"
    ...
    <span class="meilifacetsFacetToggleName"><span class="meilifacetsFacetToggleLabel"@unless ($disclosure->readsLabelAloud()) aria-hidden="true"@endunless>{{ $disclosure->label }}</span>{{ $slot }}</span>
